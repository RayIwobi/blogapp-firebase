    ...
    <div className='main-container'>
        ...
        <div className='projects-corner'>
            ...
            <div className='projectDisplays'>
               ...
               <div className='dox'>
                    <img src={login} alt='' style={{width:'650px', height:'300px', margin:'10px'}} />
                    <h3 style={{fontWeight:'700'}}>Map Pinning App</h3>
                    <h4 style={{width:'650px', lineHeight:'1.6'}}>Map Pinning App lets users drop pins on a map, add reviews to favorite locations, and save them to a database.
                ...
                <div className='cam'>
                   <div className='dox'>
                    <img src={productlisting} alt='' style={{width:'550px', height:'300px', margin:'10px'}} />
                    <h3 style={{fontWeight:'700'}}>Product listing API App</h3>
                    <h4 style={{width:'550px', lineHeight:'1.6'}}>Product Listing API App is a frontend app that fetches and displays products from the Fake Store API, simulating a basic shopping experience.
                    ...
                    Styled with vanilla CSS and powered by data from the external Fake Store API.</h4> 
                    <div className='cani'>
                        <Link><img src={github} alt='' style={{width:'20px', height:'20px'}} />Github</Link>
                        <Link><img src={web} alt='' style={{width:'20px', height:'20px'}} />Live website</Link>
                    </div>
